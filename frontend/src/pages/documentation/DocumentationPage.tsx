...
const DocumentationPage: React.FC = () => {
  ...
  const [searchResults, setSearchResults] = useState<SectionRecord[]>([]);
  const contentRef = useRef<HTMLDivElement>(null);

  const allSections = getAllSections() as SectionRecord[];
  ...
  // Navigation handlers
  const navigateToSection = (category: string, sectionId: string): void => {
